        ...
        <div className=" place-order-page">
            ...
            >
                <InputField
                    ...
                    onChange={(e) => (orderForm.topic = e.target.value)}
                />
                <SelectInputField
                    ...
                    onChange={(e) => (orderForm.typeOfPaper = e.target.value)}
                />
                <SelectInputField
                    ...
                    onChange={(e) => (orderForm.subjectArea = e.target.value)}
                />
                <TextAreaInputField
                    ...
                    onChange={(e) => (orderForm.paperDetails = e.target.value)}
                />

                <FileInputField
                    labelText="Additional Materials"
                    onChange={(e) =>
                        (orderForm.additionalMaterials = e.target.files[0])
                    }
                />
                ...
                <div className="flex flex-col justify-between sm:flex-row">
                    <SelectInputField
                        ...
                        onChange={(e) =>
                            (orderForm.paperFormat = e.target.value)
                        }
                    />
                    <SelectInputField
                        parentClasses="w-full sm:w-2/5"
                        ...
                        onChange={(e) =>
                            (orderForm.prefEnglish = e.target.value)
                        }
                    />
                </div>
                ...
                <div className="flex flex-col justify-between sm:flex-row ">
                    <InputField
                        ...
                        onChange={(e) =>
                            (orderForm.numOfSources = e.target.value)
                        }
                    />
                    <SelectInputField
                        parentClasses="w-full sm:w-2/5"
                        ...
                        onChange={(e) => (orderForm.spacing = e.target.value)}
                    />
                </div>
                ...
                <div className="input-group">
                    ...
                    <select
                        ...
                        id="academic-level"
                        onChange={(e) =>
                            (orderForm.academicLevel = e.target.value)
                        }
                    >
                ...
                <div className="input-group">
                    ...
                    <select
                        ...
                        id="number-of-pages"
                        onChange={(e) =>
                            (orderForm.numberOfPages = e.target.value)
                        }
                    >
                        <option value="" selected disabled>
                        ...
                        {numberOfPages.map((opt) => (
                            <option value={opt.pages} key={opt.pages}>
                                {opt.pages} Pages / {opt.wordsPerPage} Words
                            </option>
                        ))}
                    </select>
                </div>
                ...
                <SelectInputField
                    ...
                    onChange={(e) => (orderForm.urgency = e.target.value)}
                />
                ...
                <button
                    type="submit"
                    className="w-full mt-6 sm:w-1/2 lg:w-1/3 btn-pri"
