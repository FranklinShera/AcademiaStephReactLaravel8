...
const Orders = () => {
    ...
    const Formik = useFormik({
        ...
        validationSchema: Yup.object({
            topic: Yup.string()
                .min(8, "Topic must be atleast 8 characters!")
                .required("Topic is a required field"),
            typeOfPaper: Yup.string().required(
                "Type of Paper is a required field"
            ),
            subjectArea: Yup.string().required(
                "Subject Area is a required field"
            ),
            paperDetails: Yup.string().required(
                "Paper Details is a required field"
            ),
            ...
            paperFormat: Yup.string().required(
                "Paper Format is a required field"
            ),
            prefEnglish: Yup.string().required(
                "Preferred English is a required field"
            ),
            numOfSources: Yup.string().required(
                "Number of Sources is a required field"
            ),
            ...
            academicLevel: Yup.string().required(
                "Academic Level is a required field"
            ),
            numberOfPages: Yup.string().required(
                "Number of Pages is a required field"
            ),
    ...
    const submitPlaceOrderForm = (formFields) => {
        ...
        orderFormData.append(
            ...
            formFields.additionalMaterials
        );
        ...
        axios
            .post("/api/auth/client/orders", orderFormData, {
                headers: {
    ...
    const checkLocalOrders = () => {
        localStorage.getItem(LOCAL_STORAGE_KEY) &&
            setLocalOrders(JSON.parse(localStorage.getItem(LOCAL_STORAGE_KEY)));
    };
            ...
            <ClientLayout>
                <div className="dash_overview">
                    <div className="place-order-page">
                        ...
                        <h4 className="mt-6 text-lg text-primary-4">
                            Paper Details
                        </h4>
                        ...
                        >
                            <div className="local-order flex justify-between items-center">
                                <span className="saveBtn" onClick={saveOrder}>
                                ...
                                >
                                    <i className="ti-cloud-down mr-1"></i>Drafts
                                    ({localOrders.length})
                                </span>
                            </div>
                            ...
                            <div className="input-group">
                                ...
                                {Formik.errors.typeOfPaper &&
                                    Formik.touched.typeOfPaper && (
                                        <div className="field-errors">
                                            {Formik.errors.typeOfPaper}
                                        </div>
                                    )}
                            ...
                            <div className="input-group">
                                ...
                                {Formik.errors.subjectArea &&
                                    Formik.touched.subjectArea && (
                                        <div className="field-errors">
                                            {Formik.errors.subjectArea}
                                        </div>
                                    )}
                            ...
                            <TextAreaInputField
                                ...
                                onChange={Formik.handleChange}
                                errors={
                                    Formik.errors.paperDetails &&
                                    Formik.touched.paperDetails &&
                                    Formik.errors.paperDetails
                                }
                            />
                            ...
                            <FileInputField
                                ...
                                errors={
                                    Formik.errors.additionalMaterials &&
                                    Formik.touched.additionalMaterials &&
                                    Formik.errors.additionalMaterials
                                }
                            />
                            ...
                            <div className="flex flex-col justify-between sm:flex-row">
                                <div className="input-group w-full sm:w-2/5">
                                    ...
                                    {Formik.errors.paperFormat &&
                                        Formik.touched.paperFormat && (
                                            <div className="field-errors">
                                                {Formik.errors.paperFormat}
                                            </div>
                                        )}
                                ...
                                <div className="input-group w-full sm:w-2/5">
                                    ...
                                    {Formik.errors.prefEnglish &&
                                        Formik.touched.prefEnglish && (
                                            <div className="field-errors">
                                                {Formik.errors.prefEnglish}
                                            </div>
                                        )}
                                    ...
                                    >
                                        <option value="" selected disabled>
                                            Choose Preferred English
                                        </option>

                                        {allPreffEnglish.map((opt) => (
                                            <option value={opt.lang_name}>
                                                {opt.lang_name}
                                            </option>
                                        ))}
                                    </select>
                            ...
                            <div className="flex flex-col justify-between sm:flex-row ">
                                <InputField
                                    ...
                                    onChange={Formik.handleChange}
                                    errors={
                                        Formik.errors.numOfSources &&
                                        Formik.touched.numOfSources &&
                                        Formik.errors.numOfSources
                                    }
                                />
