...
const DirectContacts = () => {
    ...
    const openConversation = (contactersation) => {
        const clientName = contactersation.client.name
            .trim()
            .replace(/[^a-zA-Z ]/g, " ")
            .replace(/\s/g, "-")
            .toLowerCase();
        ...
        navigate(
            `/in/dashboard/contactersation/${contactersation.id}/${clientName}`
        );
    };
    ...
    useEffect(() => {
        ...
        document.querySelector("title").text =
            "AcademiaSteph21 | Direct Contacts";
                ...
                <div className="dash_overview">
                    <div className="direct-contacts">
                        <div className="second-nav">
                            <h1 className="lead-title inline">
                                DIRECT CONTACTS
                            </h1>
                        ...
                        <div className="direct-contact-label">
                            ...
                            <div className="contact-add-on"></div>

                            <div className="contact-date">Date</div>
                        </div>
                                            ...
                                            <div className="inline-block w-full max-w-lg p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                                                ...
                                                <div className="mt-2">
                                                    <div className="mb-2 text-gray-800">
                                                        ...
                                                        <span className="py-1 px-2 text-sm  rounded bg-gray-50 text-gray-600">
                                                            {
                                                                directMessage.email
                                                            }
                                                        </span>
                                                    ...
                                                    <div className="flex justify-between items-center mt-5">
                                                        <div className="w-3/5 flex justify-between">
                                                            {directMessage.mailback ==
                                                                1 && (
                                                                <span className="flex  items-center w-1/2 ">
                                                                    <img
                                                                        src="/storage/images/reply.svg"
                                                            ...
                                                            {directMessage.addonwhatsapp ==
                                                                1 && (
                                                                <span className="flex  items-center w-1/2">
                                                                    <img
                                                                        src="/storage/images/whatsapp.svg"
                                                                        className="  h-5"
                                                                        alt="Add on whatsapp"
                                                                    />
                                                                    <span className="text-xs text-gray-600">
                                ...
                                contacts.data.map((contact, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="contact-message">
                                            {contact.message.length > 52
                                                ? contact.message.slice(0, 52) +
                                                  "..."
                                                : contact.message}
                                        </div>
