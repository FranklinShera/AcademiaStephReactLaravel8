...
const Writers = () => {
    ...
    const addWriter = (formValues) => {
        axios.post('/api/auth/admin/add-writer', formValues)
            .then(res => {
                if(res.status == 201){
                    window.Toast.fire({
                        icon: "success",
                 ...
                 <div className="writers">
                     ...
                     <div className="second-nav">
                         <h1 className="lead-title inline">WRITERS</h1>
                            ...
                            <button className="px-6 py-2 bg-blue-600 rounded-full text-white" onClick={e => {
                                e.preventDefault();
                                openModal();
                            }}>Add Writer</button>
                         <div className="second-nav-controls">

                            <span className={ (writers.links?.prev) ? "p-2 cursor-pointer" : "p-2 text-gray-400"}
                                  onClick={e => {
                                      e.preventDefault()
                             ...
                             <span className={ (writers.links?.next) ? "p-2 cursor-pointer ml-4" : "p-2 text-gray-400 ml-4"}
                                   onClick={e => {
                                       e.preventDefault()
                     ...
                     <div className="writers-list">
                                                    ...
                                                    <div className="flex justify-between">
                                                     ...
                                                     <div className="flex  justify-between">
                                                         ...
                                                         <InputField
                                                             ...
                                                             onBlur={Formik.handleBlur}
                                                             onChange={Formik.handleChange}
                                                             errors={(Formik.errors.speciality && Formik.touched.speciality) && Formik.errors.speciality}
                                                         />
                                                     </div>
                         ...
                         {(writers.length != 0 && !loading ) && writers.data.map((writer , index) => (
                             <div className="writer" onClick={e => {
                                 e.preventDefault();
                             }}>
