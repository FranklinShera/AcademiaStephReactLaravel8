...
const Notification = ({ userType }) => {
    ...
    const AppTime = useSelector((state) => state.appTime);
    ...
    useEffect(() => {
        setInterval(() => {
            ...
            let elapsed = currTime - tst;
            const overTime = overtime * 60;

            let remaining = overTime - elapsed;
                    ...
                    <div className="min-h-screen px-4 text-center">
                        ...
                        >
                            <div className="inline-block  max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                                ...
                                <div className="mt-3">
                                    <p className="text-sm">
                                        You have {countDown} seconds to refresh
                                        your session!
                                    </p>
                                </div>
