...
const SubjectArea = ({ themeClass }) => {
    ...
    const toggleStatus = (id) => {
        ...
        axios
            .post("/api/auth/admin/subject-area-toggle/" + id)
            .then((res) => {
                if (res.status == 200) {
                    window.Toast.fire({
                        icon: "success",
    ...
    const addSubjectArea = async (subjectAreaForm) => {
        ...
        axios
            .post("/api/auth/admin/subject-area", subjectAreaForm)
            .then((res) => {
                if (res.status == 201) {
                    window.Toast.fire({
                        icon: "success",
            ...
            <div className="new--table--item">
                <form action="" onSubmit={formik.handleSubmit}>
                    ...
                    <div className="text-sm">
                        Default Subject Area Status is{" "}
                    ...
                    >
                        {" "}
                        {localLoad ? "Adding" : "Add Subject Area"}
                    </button>
                </form>
                    ...
                    <div className="links--fetch">
                        <button
                            ...
                            onClick={(e) => {
                                ...
                                links.prev &&
                                    dispatch(
                                        adminFetchSubjectAreas(links.prev)
                                    );
                            }}
                        >
                            PREV
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                ...
                                links.prev &&
                                    dispatch(
                                        adminFetchSubjectAreas(links.first)
                                    );
                            }}
                        >
                            FIRST
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                ...
                                links.next &&
                                    dispatch(
                                        adminFetchSubjectAreas(links.last)
                                    );
                            }}
                        >
                            LAST
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                ...
                                links.next &&
                                    dispatch(
                                        adminFetchSubjectAreas(links.next)
                                    );
                            }}
                        >
                            NEXT
