...
const AcademicLevel = ({ themeClass }) => {
    ...
    const toggleStatus = (id) =>{
        ...
        axios.post('/api/auth/admin/academic-level-toggle/'+id).then(res =>{
            if(res.status == 200){
                                ...
                                <div className={`table--item ${themeClass}`} key={index}>
                                    ...
                                    <div className="table--item--split--status">
                                        ...
                                        <span className="table--item--actions">
                                             ...
                                             <i className={`ti-exchange-vertical cursor-pointer ${ academicLevel.active ? 'text-palblue' : 'text-dark-1'}`}
                                                onClick={(e) => {
                                                    e.preventDefault()
