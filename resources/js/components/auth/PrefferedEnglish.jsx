...
const PrefferedEnglish = ({ themeClass }) => {
    ...
    const deletePreffEng = async (id) => {
        ...
        const res = await axios.delete(
            "/api/auth/admin/preffered-english/" + id
        );
    ...
    const toggleStatus = (id) => {
        ...
        axios
            .post("/api/auth/admin/preffered-english-toggle/" + id)
            .then((res) => {
                if (res.status == 200) {
                    window.Toast.fire({
                        icon: "success",
    ...
    const addPreffLang = async (langForm) => {
        ...
        axios
            .post("/api/auth/admin/preffered-english", langForm)
            .then((res) => {
                if (res.status == 201) {
                    window.Toast.fire({
                        icon: "success",
                ...
                <div className="core--list--table">
                    ...
                    <div className="core--table--body">
                        {loading || localLoad ? (
                            ...
                            allPreffEnglish.map((prefferedLang, index) => (
                                <div
                        ...
                        {allPreffEnglish.length == 0 && !loading && (
                            <div className="no--table--items">
                                <h1>
                                    We Could'nt Find Any Preffered Languages
                                    (Eng)!
                                </h1>
            ...
            <div className="new--table--item">
                <form action="" onSubmit={formik.handleSubmit}>
                    <InputField
                        ...
                        errors={
                            formik.errors.lang_name &&
                            formik.touched.lang_name &&
                            formik.errors.lang_name
                        }
                    />

                    <div className="text-sm">
                        Default Preffered English Status is{" "}
                    ...
                    <div className="links--fetch">
                        <button
                            ...
                            onClick={(e) => {
                                ...
                                links.prev &&
                                    dispatch(
                                        adminFetchPrefferedEnglish(links.prev)
                                    );
                            }}
                        >
                            PREV
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                ...
                                links.prev &&
                                    dispatch(
                                        adminFetchPrefferedEnglish(links.first)
                                    );
                            }}
                        >
                            FIRST
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                ...
                                links.next &&
                                    dispatch(
                                        adminFetchPrefferedEnglish(links.last)
                                    );
                            }}
                        >
                            LAST
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                ...
                                links.next &&
                                    dispatch(
                                        adminFetchPrefferedEnglish(links.next)
                                    );
                            }}
                        >
                            NEXT
