...
import { adminFetchPaperTypes } from "../../actions/OrderActions";
...
const PaperType = ({ themeClass }) => {
    ...
    const deletePaperType = async (id) => {
        ...
        const res = await axios.delete("/api/auth/admin/paper-type/" + id);
    ...
    const toggleStatus = (id) => {
        ...
        axios
            .post("/api/auth/admin/paper-type-toggle/" + id)
            .then((res) => {
                if (res.status == 200) {
                    window.Toast.fire({
                        icon: "success",
    ...
    const addPaperType = async (paperTypeForm) => {
        ...
        axios
            .post("/api/auth/admin/paper-type", paperTypeForm)
            .then((res) => {
                if (res.status == 201) {
                    window.Toast.fire({
                        icon: "success",
        ...
        <div className="table-group">
            ...
            <div className="new--table--item">
                <form action="" onSubmit={formik.handleSubmit}>
                    ...
                    >
                        {" "}
                        {localLoad ? "Adding" : "Add Paper Type"}
                    </button>
                </form>
                    ...
                    <div className="links--fetch">
                        <button
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                links.prev &&
                                    dispatch(adminFetchPaperTypes(links.prev));
                            }}
                        >
                            PREV
                        </button>
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                links.prev &&
                                    dispatch(adminFetchPaperTypes(links.first));
                            }}
                        >
                            FIRST
                        </button>
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                links.next &&
                                    dispatch(adminFetchPaperTypes(links.last));
                            }}
                        >
                            LAST
                        </button>
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                links.next &&
                                    dispatch(adminFetchPaperTypes(links.next));
                            }}
                        >
                            NEXT
                        </button>
